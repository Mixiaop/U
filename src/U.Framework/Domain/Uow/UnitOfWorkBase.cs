...
namespace U.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new UException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new UException("Complete is called before!");
            }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new UException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
