...
namespace U.DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        IEnumerable<T> GetList<T, T2>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T> mapOutput, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
        IEnumerable<T> GetList<T, T2, T3>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T3, T> mapOutput, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
        ...
        IEnumerable<T> GetPage<T, T2>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T> mapOutput, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
        IEnumerable<T> GetPage<T, T2, T3>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T3, T> mapOutput, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;

        int Count<T>(IDbConnection connection, object predicate, IDbTransaction transaction, int? commandTimeout) where T : class;
        int Count<T>(IDbConnection connection, Func<IClassMapper> mapInput, object predicate, IDbTransaction transaction, int? commandTimeout) where T : class;
    ...
    public class DapperImplementor : IDapperImplementor
    {
        ...
        public IEnumerable<T> GetList<T, T2>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T> mapOutput, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            var classMap = mapInput();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            ...
            return connection.Query<T, T2, T>(sql, mapOutput, dynamicParameters, transaction, buffered, classMap.MultiQuerySplitOn, commandTimeout, CommandType.Text);
        }

        public IEnumerable<T> GetList<T, T2, T3>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T3, T> mapOutput, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            var classMap = mapInput();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            ...
            return connection.Query<T, T2, T3, T>(sql, mapOutput, dynamicParameters, transaction, buffered, classMap.MultiQuerySplitOn, commandTimeout, CommandType.Text);
        }
        #endregion
        ...
        public IEnumerable<T> GetPage<T, T2>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T> mapOutput, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            var classMap = mapInput();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        public IEnumerable<T> GetPage<T, T2, T3>(IDbConnection connection, Func<IClassMapper> mapInput, Func<T, T2, T3, T> mapOutput, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            var classMap = mapInput();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
