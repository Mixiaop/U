...
namespace U.Segmentation.Jieba.FinalSeg
{
    public class Viterbi : IFinalSeg
    {
        ...
        private static JiebaSettings _settings = UPrimeEngine.Instance.Resolve<JiebaSettings>();
        private Viterbi()
        {
            LoadModel();
        }
        ...
        private void LoadModel()
        {
            ...
            var transJson = File.ReadAllText(_settings.ProbTransFileName.GetResourcePath());
