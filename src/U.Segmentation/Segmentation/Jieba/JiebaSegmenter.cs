...
using U.Segmentation.Jieba.FinalSeg;

namespace U.Segmentation.Jieba
{
    public class JiebaSegmenter : ISegmenter
    {
        ...
        {
            var dictFullPath = fileName.GetResourcePath();
            Debug.WriteLine("Initializing user dictionary: " + fileName);
