...
namespace U.Utilities.Web
{
    ...
    public class WebHelper
    {
        ...
        /// <returns></returns>
        public static string GetLocation(bool useSsl)
        {
        ...
        public static string CreateQueryString(Dictionary<string, string> paramTemp)
        {
        ...
        /// <returns>拼接完成以后的字符串</returns>
        public static string CreateQueryStringUrlencode(Dictionary<string, string> paramTemp, Encoding code)
        {
            if (paramTemp != null && paramTemp.Count == 0)
                return string.Empty;
