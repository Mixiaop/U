...
namespace U.Domain.Entities
{
    ...
    public static class EntityHelper
    {
        ...
        public static Type GetPrimaryKeyType(Type entityType)
        {
            ...
            throw new UException("Can not find primary key type of given entity type: " + entityType + ". Be sure that this entity type implements IEntity<TPrimaryKey> interface");
        }
    }
}
