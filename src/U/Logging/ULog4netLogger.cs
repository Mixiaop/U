...
{
    [Serializable]
    public class ULog4netLogger : MarshalByRefObject, Logger
    {
        private static readonly Type declaringType = typeof(ULog4netLogger);

        //private readonly Lazy<ShellSettings> _shellSettings;

        public ULog4netLogger(log4net.Core.ILogger logger, ULog4netFactory factory)
        {
            Logger = logger;
            Factory = factory;
        ...
        internal ULog4netLogger()
        {
        }

        internal ULog4netLogger(ILog log, ULog4netFactory factory)
        ...
        protected internal ULog4netFactory Factory { get; set; }
