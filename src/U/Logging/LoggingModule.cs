...
namespace U.Logging
{
    public class LoggingModule : Module
    {
        ...
        protected override void Load(ContainerBuilder moduleBuilder) {
            ...
            moduleBuilder.RegisterType<ULog4netFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
        ...
        private static ILogger CreateLogger(IComponentContext context, IEnumerable<Parameter> parameters) {
            ...
            return loggerFactory.CreateLogger(typeof(ULog4netLogger));

            //return context.Resolve<ILogger>();
        }
        #endregion
    }
}
