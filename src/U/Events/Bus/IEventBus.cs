...
namespace U.Events.Bus
{
    /// <summary>
    /// 定义event bus 接口
    /// 领域驱动设计中，它承担传输数据的作用，可以解耦模块之间的耦合性
    /// Define interface of the event bus. 
    /// </summary>
    public interface IEventBus
    {
        ...
        /// Given action is called for all event occurrenced.
        /// </summary>
        /// <typeparam name="TEventData">event type</typeparam>
        /// <param name="action">cation to handle events</param>
        /// <returns></returns>
