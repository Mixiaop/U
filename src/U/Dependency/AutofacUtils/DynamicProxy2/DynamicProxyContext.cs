...
namespace U.Dependency.AutofacUtils.DynamicProxy2
{
    ...
    {
        internal const string ProxyContextKey = "U.Dependency.AutofacUtils.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        internal const string InterceptorServicesKey = "U.Dependency.AutofacUtils.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
            ...
            where TConcreteReflectionActivatorData : ConcreteReflectionActivatorData
        {
            ...
            registrationBuilder.OnPreparing(e =>
            {
                ...
                if (e.Component.Metadata.TryGetValue(InterceptorServicesKey, out value))
                {
                    ...
                    var pList = new[] { parameter }.Concat(e.Parameters).ToArray();
                    e.Parameters = pList;
                }
            });
        }
