...
namespace U.Tests.ConsoleApp.AutofacUtils.DynamicProxy2
{
    public class DynamicProxyContext
    {
        const string ProxyContextKey = "U.AutofacUtils.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        const string InterceptorServicesKey = "U.AutofacUtils.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
