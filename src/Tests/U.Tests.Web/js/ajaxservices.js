//Generated by U.FakeMvc.UI.AjaxProGeneratePageBase：20161216140003
...
UserService_class = function() {};
Object.extend(UserService_class.prototype, Object.extend(new AjaxPro.AjaxClass(), {
	SayHi: function() {
		return this.invoke("SayHi", {}, this.SayHi.getArguments().slice(0));
	},
	url: '/ajaxpro/U.Tests.Web.FakeMvc.TestAjaxController,U.Tests.Web.ashx'
}));
UserService = new UserService_class();
