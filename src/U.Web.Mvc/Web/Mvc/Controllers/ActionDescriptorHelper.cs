...
namespace U.Web.Mvc.Controllers
{
    internal static class ActionDescriptorHelper
    {
        public static MethodInfo GetMethodInfo(ActionDescriptor actionDescriptor)
        {
            ...
            throw new UException("Could not get MethodInfo for the action '" + actionDescriptor.ActionName + "' of controller '" + actionDescriptor.ControllerDescriptor.ControllerName + "'.");
        }
    }
}
